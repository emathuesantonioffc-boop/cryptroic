...
func log(_ msg: String) { AppLog.shared.append("[Cryptroic] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/Cryptroic/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/Cryptroic/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("Cryptroic", forHTTPHeaderField: "User-Agent")
